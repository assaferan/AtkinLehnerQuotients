...
// Errors on hyperelliptic N; use XZeroNstar for that case.
    ...
    repeat
        ...
        // A genus 3 canonical curve is a plane quartic. For g >= 4 the
        // canonical ideal is generated by quadrics unless the curve is
        // trigonal or a plane quintic (Petri), when cubics are needed too,
        // so start with quadrics and add cubics below if they leave the
